        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form:form action="/admin/product/update" method="POST" enctype="multipart/form-data"
                        modelAttribute="product"
                    >
                        <div class="row">
                            <div class="form-group">
                                <h3>Update product with id = ${product.id}</h3>
                                <hr/>
                            </div>
                            ...
                            <div class="form-group col-12 mb-2">
                                ...
                                <form:textarea rows="1" class="form-control ${not empty errorDetailDesc ? 'is-invalid' : ''}"
                                    path="detailDesc"
                                ></form:textarea>
                                ${errorDetailDesc}
                            </div>
                            ...
                            <div class="form-group col-4 mb-2">
                                ...
                                <form:input type="number" min="0" class="form-control ${not empty errorQuantity ? 'is-invalid' : ''}" 
                                    path="quantity"
                                />
                                ${errorQuantity}
                            </div>
